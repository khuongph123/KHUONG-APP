...
const BROWSERLESS_CONNECTION_STRING = 'wss://chrome.browserless.io?token=2TCK6pkKFF5RpZz20e351adfad615ea7a491c019c4ca54308';
...
// --- HÀM KHỞI ĐỘNG TRÌNH DUYỆT (ĐÃ SỬA LỖI) ---
async function initializeBrowser() {
    if (!browserInstance) {
        console.log("[LOG] Đang kết nối đến trình duyệt ảo của Browserless.io...");

        // Dòng kiểm tra đã được sửa lại cho đúng
